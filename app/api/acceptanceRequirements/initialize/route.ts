    ...
    const requirementsByType = {
      ISAG: [
        ...
        },
        {
          ...
          name: "Proof of Technical Competence",
          description: "Upload CVs, licenses, and track records",
        },
        {
          order: 9,
          type: "PROOF_FINANCIAL_CAPABILITY",
          name: "Proof of Financial Capability",
          description: "Upload Statement of Assets & Liabilities, Financial Statements, ITR",
        },
        {
          order: 10,
          type: "ARTICLES_INCORPORATION",
          name: "Articles of Incorporation/Partnership",
          description: "Upload SEC Certified articles (if applicable)",
        },
        {
          order: 11,
          type: "OTHER_SUPPORTING_PAPERS",
          name: "Other Supporting Papers",
      ...
      CSAG: [
        ...
        },
        {
          order: 8,
          type: "PROOF_FINANCIAL_CAPABILITY",
          name: "Proof of Technical and Financial Capability",
          description: "Upload Statement of Assets & Liabilities, Financial Statements, ITR",
        },
        {
          order: 9,
